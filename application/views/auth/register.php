...
<head>
  <meta charset="utf-8">
    ...
    <title>E Recruitment - Register </title>
				...
				<div class="row no-gutters justify-content-md-center">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="p-40 bg-white content-bottom">
							<form action="<?= base_url() ?>assets/index.html" method="post" class="form-element">
								<div class="form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-info border-info"><i class="ti-user"></i></span>
										</div>
										<input type="text" class="form-control pl-15" placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" class="form-control pl-15" placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" class="form-control pl-15" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
